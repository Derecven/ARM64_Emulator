...
void executeAND(string op1, string op2, string op3) {
    x_registers[op1] = x_registers[op2] & x_registers[op3];
}
...
void executeB(string destination) {
    ...
    pc_register = destination;//update program counter to the target address
}
...
void executeEOR(string op1, string op2, string op3) {
    register[op1] = x_registers[op1] ^ x_registers[op2]; // performs bitwise XOR
...
void executeMUL(string op1, string op2, string op3) {
    ...
    register[op1] = x_registers[op2] * x_registers[op3]
}
...
void executeSTR(string op1, string op2) {
    int address = x_registers[op2]; // int address is assigned the value from op 2 is the register containing the address
    memory[address] = x_registers[op1]; //this assigns value in op1 to the memeory address
    }
